...
![Figura 2 – Esquema del medio puente resistivo para el módulo ZMPT101B alimentado a 12 V](mediopuentesim.jpg)
...
![Figura 3 – Implementación física del medio puente resistivo hacia la entrada A2 de la KC868-A6](mediopuentefisico.jpg)
...
![Figura 6 – Vista general del modelo de co-simulación del invernadero en MATLAB/Simulink](simulink.jpg)
...
![Figura 5 – Subsistema de medición de tensión y corriente (ACS758 + ZMPT101B) en Simulink](simulinkpowermeter.jpg)
...
3. **Subsistema SHT45**
![Figura 4 – Bloque de simulación del SHT45 y adaptador I²C–digital en Simulink](simulacioni2c.jpg)
...
![Figura 7 – Respuesta simulada de temperatura, humedad y señal de mando en el osciloscopio de Simulink](scopeTemperaturax3.jpg)
...
## VII. Trabajo futuro: hacia un nodo AIoT
